...
class ScanNetPlusPlusDataset(Dataset):
    ...
    def __init__(
        ...
        super(ScanNetPlusPlusDataset, self).__init__()
        ...
        self.top100_labels = np.array(TOP100_CLASS_INDEX)
    ...
    def get_data(self, idx):
        ...
        if "sampled_instance_labels" in data.keys():
            instance = data["sampled_instance_labels"]
        else:
...
# @DATASETS.register_module()
# class ScanNet200Dataset(ScanNetPlusPlusDataset):
